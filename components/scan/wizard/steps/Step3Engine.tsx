        ...
        {profile.engineCards.map((card: EngineCardConfig) => {
          ...
          return (
            <button
              ...
              className={[
                "group flex min-h-[120px] touch-manipulation flex-col items-start gap-3 rounded-3xl border p-5 text-start transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--scanw-accent-muted)] focus-visible:ring-offset-2 active:scale-[0.99]",
                active
