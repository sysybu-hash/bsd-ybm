...
export default function InteractivePulse() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {voicePanelOpen ? (
          <motion.div
            ...
            className="overflow-hidden rounded-2xl border border-indigo-100 bg-indigo-50 text-sm text-indigo-900 px-4 py-3"
          >
      ...
      <div>
        <div className="flex justify-between text-xs mb-2 uppercase font-black tracking-widest text-indigo-700">
        ...
        <div className="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: "80%" }}
            className="h-full bg-indigo-500 shadow-[0_0_15px_#3b82f6]"
          />
        </div>
