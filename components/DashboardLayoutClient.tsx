...
export default function DashboardLayoutClient({
  ...
  return (
    <div className="dashboard-design-shell min-h-screen" dir="rtl">
      <header className="border-b border-[color:var(--dash-line)] bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          <div className="min-w-0">
            <p className="text-xs font-black uppercase text-[color:var(--dash-muted)]">Dashboard Bridge</p>
            <h1 className="truncate text-lg font-black text-[color:var(--dash-text)]">
          ...
          <div className="flex shrink-0 items-center gap-3">
            <Link
              href="/app"
              className="inline-flex items-center gap-2 rounded-xl bg-[color:var(--dash-purple)] px-4 py-2.5 text-sm font-black text-white"
            >
              חזרה ל-Workspace v2
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-[color:var(--dash-line)] bg-white px-4 py-2.5 text-sm font-black text-[color:var(--dash-text)]"
            >
              יציאה
