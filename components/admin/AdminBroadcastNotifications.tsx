  ...
  return (
    <div className="mt-10 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <p className="mb-6 text-sm font-medium text-gray-400">
        יוצר התראה פנימית לכל משתמש במצב <strong className="text-gray-600">ACTIVE</strong>. ההודעה תופיע בפעמון בראש הדשבורד (לא מייל).
      </p>

      <form onSubmit={onSubmit} className="max-w-2xl space-y-4">
        <div>
          <label htmlFor="bc-title" className="mb-1 block text-xs font-bold text-gray-500">
            כותרת
          </label>
          <input
            id="bc-title"
        ...
        <div>
          <label htmlFor="bc-body" className="mb-1 block text-xs font-bold text-gray-500">
            תוכן
          </label>
          <textarea
            id="bc-body"
