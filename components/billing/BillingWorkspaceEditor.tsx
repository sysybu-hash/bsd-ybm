  ...
  return (
    <section className="card-avenue bg-white p-6 shadow-sm md:p-8" dir={dir}>
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mt-3">
            <button
              type="button"
              onClick={addLine}
              className="inline-flex items-center gap-2 text-sm font-bold text-indigo-300 hover:underline"
            >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        ...
        {msg ? (
          <span className={`text-sm font-bold ${msg.startsWith("✓") ? "text-emerald-400" : "text-rose-700"}`}>
            {msg}
          </span>
        ) : null}
      </div>
