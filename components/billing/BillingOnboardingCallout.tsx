...
export default function BillingOnboardingCallout({ text }: { text: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-xl bg-white/90 border border-gray-100 p-4 text-gray-700 leading-relaxed whitespace-pre-wrap text-[13px]">
        {text}
      </div>
      <button
        type="button"
        onClick={() => void copy()}
        className="mt-3 inline-flex items-center gap-2 rounded-xl border border-gray-100 bg-white px-4 py-2 text-xs font-bold text-gray-600 hover:bg-gray-50"
      >
