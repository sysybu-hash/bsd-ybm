...
export default async function FinancialInsightsWidget({
  ...
  if (!organizationId) {
    return (
      <div
        className="card-avenue border-indigo-200 bg-indigo-50 p-6 text-sm text-indigo-800"
        dir={dir}
      >
        <p className="mb-2 font-bold text-indigo-700">תובנות BSD-YBM</p>
  ...
  return (
    <div
      className="card-avenue border-emerald-200/90 bg-gradient-to-b from-emerald-50/80 to-white p-6 text-gray-800 shadow-sm"
      dir={dir}
    >
