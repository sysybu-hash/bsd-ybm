  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="39"
        rx="11.5"
        stroke={`url(#${gid}-border)`}
        strokeWidth="1"
      />
      <path
        d="M0 12C0 5.373 5.373 0 12 0h16c6.627 0 12 5.373 12 12v6C28 14 12 14 0 18v-6z"
        fill={`url(#${gid}-reflection)`}
        opacity="0.4"
      />

      {/* Beam + structure — זרימת עבודה דיגיטלית */}
      <path
        d="M11 26c4-9 8-13 14-13 3.5 0 6 1.5 8 4"
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="39"
        rx="11.5"
        stroke={`url(#${gid}-border-l)`}
        strokeWidth="1"
      />
      <path
        d="M0 12C0 5.373 5.373 0 12 0h16c6.627 0 12 5.373 12 12v6C28 14 12 14 0 18v-6z"
        fill={`url(#${gid}-reflection-l)`}
        opacity="0.6"
      />
      ...
      <path
        d="M11 26c4-9 8-13 14-13 3.5 0 6 1.5 8 4"
        stroke={`url(#${gid}-stroke-l)`}
        strokeWidth="3"
        strokeLinecap="round"
        filter={`url(#${gid}-glow-l)`}
      />
      <path
        d="M13 15h14v3H13z"
        fill={`url(#${gid}-accent-l)`}
        filter={`url(#${gid}-shadow-l)`}
      />
...
export default function BsdYbmLogo({
  ...
  const isDark = variant === "marketing-dark" || variant === "footer-dark";
  ...
  if (iconOnly) {
    ...
    const wrapClass =
      `flex h-10 w-10 items-center justify-center rounded-lg border border-[color:var(--line)] bg-white transition hover:bg-[color:var(--canvas-sunken)] ${className}`.trim();
    if (href) {
      return (
        <Link
          href={href}
    ...
    <span className={`flex items-center gap-2.5 ${className}`}>
      ...
      <span className="min-w-0 text-right leading-tight">
        ...
        {subtitle !== undefined ? (
          ...
          <span
            className={`mt-0.5 block whitespace-nowrap font-semibold ${s.sub} text-slate-500 ${variant === "marketing-dark" || variant === "footer-dark" ? "!text-slate-400" : ""}`}
          >
            פלטפורמה לתפעול עסקי חכם
          </span>
        )}
      </span>
    </span>
