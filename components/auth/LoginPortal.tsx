    ...
    <AuthPageShell secondaryNav={{ href: "/register", label: "הרשמה" }}>
      ...
      >
          ...
          <div className="mt-5 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                {sessionName ? <p className="text-xs text-gray-500 break-all">{sessionEmail}</p> : null}
              </div>
            </div>
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 rounded-xl border border-gray-200 bg-white px-3 py-2 text-xs font-bold text-gray-700 hover:bg-gray-50 transition"
              >
        ...
        <button
          ...
          className="mt-6 flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white py-3.5 text-sm font-bold text-gray-800 hover:bg-gray-50 transition disabled:opacity-60"
        >
          {loadingGoogle ? (
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/15"
          />
          <input
            name="password"
            type="password"
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3.5 text-sm font-bold text-white hover:bg-indigo-700 transition disabled:opacity-60"
          >
