    ...
    <nav className="sticky top-0 z-[100] border-b border-gray-100 bg-white/95 backdrop-blur-sm" dir={dir}>
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-2 sm:flex">
          <LanguageSwitcher />
          <Link href="/login" className="rounded-xl border border-gray-200 px-4 py-2 text-sm font-bold text-gray-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-600">
            {t("nav.login")}
          </Link>
