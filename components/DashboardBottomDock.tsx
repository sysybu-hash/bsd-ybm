...
export default function DashboardBottomDock({ orgId }: { orgId: string }) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex flex-row items-center gap-2 rounded-2xl border border-white/[0.08] bg-[#0a0b14] px-2 py-2 shadow-lg shadow-gray-200/70 sm:gap-3 sm:px-3 [&_button]:transition-transform [&_button]:duration-200 [&_button:hover]:scale-105">
