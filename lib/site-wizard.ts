...
export const SITE_WIZARD_STEPS: WizardStep[] = [
  {
    id: "start",
    title: "Start",
    description: "Understand the platform and pick your path.",
    primaryRoute: "/wizard",
  ...
  },
  {
    ...
    primaryRoute: "/dashboard/billing",
    routes: ["/dashboard/billing", "/dashboard/settings", "/dashboard/trial-expired"],
  },
  {
    id: "operate",
    title: "Operate",
