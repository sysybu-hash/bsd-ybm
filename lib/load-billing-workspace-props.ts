...
import type SubscriptionManagementWorkspace from "@/components/billing/SubscriptionManagementWorkspace";

export type SubscriptionManagementWorkspaceProps = ComponentProps<typeof SubscriptionManagementWorkspace>;

export async function loadSubscriptionManagementWorkspaceProps(
  searchParams: Promise<{ tab?: string; orgId?: string }>,
): Promise<SubscriptionManagementWorkspaceProps> {
