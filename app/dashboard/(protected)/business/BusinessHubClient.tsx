        ...
        {wonContacts.length > 0 && (
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-black text-emerald-900">{wonContacts.length} עסקאות נסגרו — ממתינות לחשבונית</p>
              <p className="text-sm text-emerald-700 mt-0.5">לחץ על שם הלקוח להנפקה מהירה עם הפרטים מולאו אוטומטית</p>
            </div>
            <div className="flex flex-wrap gap-1.5">
              ...
              {wonContacts.length > 3 && (
                <span className="rounded-xl border border-emerald-300 px-3 py-1.5 text-xs font-bold text-emerald-700">
