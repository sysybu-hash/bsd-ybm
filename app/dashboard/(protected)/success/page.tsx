    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        <button
          ...
          className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-xl shadow-blue-600/20"
        >
