        ...
        <div className="cursor-pointer overflow-hidden rounded-2xl ring-1 ring-white/10 shadow-xl shadow-black/20 transition-all duration-300 hover:scale-[1.02] hover:ring-indigo-400/60">
          ...
          <div className="flex h-[400px]">
            <div className="w-[155px] bg-[#0d0d1a] border-l border-white/5 flex flex-col py-5 px-3 shrink-0 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-indigo-600/20 rounded-full blur-2xl pointer-events-none" />
              <div className="flex items-center gap-2 mb-7 px-1 relative">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-sky-500 flex items-center justify-center text-white text-xs font-black shadow-lg shadow-indigo-500/40">B</div>
            ...
            <div className="w-[155px] bg-indigo-950 flex flex-col py-5 px-3 shrink-0">
              ...
              {NAV.map((item, i) => (
                <div key={item} className={`flex items-center gap-2 px-2 py-1.5 rounded-xl text-[11px] mb-0.5 font-medium ${
                  i === 0 ? "bg-indigo-500/25 text-indigo-100 border-r-2 border-indigo-400" : "text-indigo-300/40 hover:bg-indigo-500/10"
                }`}>
