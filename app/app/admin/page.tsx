        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <Link href="/app/billing?tab=control" className="v2-button v2-button-primary">
                מרכז מנויים
                <ArrowUpRight className="h-4 w-4" aria-hidden />
              </Link>
              <Link href="/app/intelligence" className="v2-button v2-button-secondary">
                Intelligence
                <ArrowUpRight className="h-4 w-4" aria-hidden />
              </Link>
              <Link
                href={activeSection === "broadcast" ? "/app/admin" : "/app/admin?section=broadcast"}
          ...
          <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
            <div className="v2-panel p-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link href="/app/billing?tab=control" className="v2-button v2-button-secondary">
                  טבלת מנויים מלאה
                  <ArrowUpRight className="h-4 w-4" aria-hidden />
                </Link>
              </div>
                ...
                {recentOrganizations.map((organization) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link
                        href={`/app/billing?tab=control&orgId=${organization.id}`}
